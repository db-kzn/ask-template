using ASK.Server.Api.Endpoints;
using ASK.Server.Api.Middleware;
using ASK.Server.Application;
...
using ASK.Server.Infrastructure.Extensions;
...
using (var scope = app.Services.CreateScope())
{
  ...
  {
    app.Logger.LogError(ex, "❌ Error occurred during seed data.");
    throw;
  }
}
